...
<head>
    ...
    <!-- Calendar CSS -->
    <link href="{{asset('/dist/plugins/bower_components/calendar/dist/fullcalendar.css')}}" rel="stylesheet" />
    <!-- Custom CSS -->
...
<body class = "fix-header ">
                            ...
                            @if ($counter == 0 || ($counter > 0 && $akses[$counter]->ketjenis != $akses[$counter-1]->ketjenis))
                                <li> 
                                    <a class="has-arrow waves-effect" href="javascript:void(0)" aria-expanded="false">
                                        ...
                                        <div style="font-size: 12px;" class="hide-menu">{{ $akses[$counter]->ketjenis }}</div>
                                    </a>
                                    <div class="sidebarmenu">
    ...
    <script>
        ...
        <!--Morris JavaScript -->
        <script src="{{ asset('/dist/plugins/bower_components/raphael/raphael-min.js') }}"></script>
        <script src="{{ asset('/dist/plugins/bower_components/morrisjs/morris.js') }}"></script>
        ...
        {{-- calendar --}}
        <!-- Calendar JavaScript -->
        <script src="{{asset('/dist/plugins/bower_components/calendar/jquery-ui.min.js')}}"></script>
        <script src="{{asset('/dist/plugins/bower_components/moment/moment.js')}}"></script>
        <script src='{{asset('/dist/plugins/bower_components/calendar/dist/fullcalendar.min.js')}}'></script>
        {{-- <script src="{{asset('/dist/plugins/bower_components/calendar/dist/cal-init.js')}}"></script> --}}
