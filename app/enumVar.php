...
class enumVar {
    ...
    const CATEGORY_MATERIAL_BLOWER = 1;
    const CATEGORY_MATERIAL_GASES = 2;
    
    const CATEGORY_MATERIAL_DESC_BLOWER = 'Blower';
    const CATEGORY_MATERIAL_DESC_GASES = 'Gases';

    public function listCategoryMaterial($name="id") {
        if ($name=="id")
            return array(
                self::CATEGORY_MATERIAL_BLOWER, 
                self::CATEGORY_MATERIAL_GASES, 
            );
        else
        return array(
            self::CATEGORY_MATERIAL_DESC_BLOWER, 
            self::CATEGORY_MATERIAL_DESC_GASES, 
        );
    }
